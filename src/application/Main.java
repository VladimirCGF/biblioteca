...
public class Main {
    public static void main(String[] args) {
        ...
        while (opcao == 's') {
            ...
            System.out.println("Deseja continuar cadastrando autores ? Digite 's' para Sim");
        ...
        while (opcao == 's') {
            ...
            System.out.println("Deseja continuar cadastrando livros ? Digite 's' para Sim");
            opcao = sc.next().toLowerCase().charAt(0);
        }
        ...
        System.out.println("Qual autor deseja imprimir");
        ...
        System.out.println("Qual livro deseja imprimir");
        ...
        System.out.println("Deseja adicionar um novo livro á biblioteca ? Digite 's' para Sim");
        opcao = sc.next().toLowerCase().charAt(0);
        while (opcao == 's') {
            System.out.println("Qual nome do autor ?");
            String buscarAutor = sc.next();
